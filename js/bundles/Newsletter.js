...
var _ToastSoy = __webpack_require__(134);
...
var _metalAlert = __webpack_require__(131);
...
var _Newsletter = __webpack_require__(137);
...
var Newsletter = function (_Component) {
	...
	_createClass(Newsletter, [{
		...
		value: function subscribeToNewsletter(event) {
			var _this2 = this;

			event.preventDefault();

			this.sendSubscriptionToWeDeploy(event.target.email.value).then(function (result) {
				event.target.email.value = "";
				_this2.showToast('Thanks for subscribing!', 'alert-success');
			}).catch(function (error) {
				_this2.showToast('Something wrong happened! Please come back later.', 'alert-danger');
			});
		}
	}, {
		key: 'sendSubscriptionToWeDeploy',
		value: function sendSubscriptionToWeDeploy(userEmail) {
			return WeDeploy.data('db.wedeploy.com').create('newsletter', {
				email: userEmail,
		...
		key: 'showToast',
		value: function showToast(bodyText, toastClass) {
			if (this.toast) {
				this.toast.dispose();
				this.toast = null;
			}

			this.toast = new _metalToast2.default({
				body: bodyText,
				dismissible: true,
...
_metalSoy2.default.register(Newsletter, _Newsletter2.default);
...
var _metalAnim = __webpack_require__(133);
...
var _AlertSoy = __webpack_require__(132);
...
_metalSoy2.default.register(Alert, _AlertSoy2.default);
...
_metalSoy2.default.register(Alert, templates);
exports.Alert = Alert;
...
class Newsletter extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(Newsletter, templates);
