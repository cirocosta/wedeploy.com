...
var _Feedback = __webpack_require__(136);
...
var Feedback = function (_Component) {
	...
	_createClass(Feedback, [{
		key: 'sendFeedback',
		value: function sendFeedback(event) {
			var _this2 = this;

			this.sendFeedbackToWeDeploy(event.target.dataset.feedback == 'true').then(function (result) {
				_this2.showToast('Thanks for your feedback!', 'alert-success');
			}).catch(function (error) {
				_this2.showToast('Something wrong happened! Please try again later.', 'alert-danger');
			});
		}
	}, {
		key: 'sendFeedbackToWeDeploy',
		value: function sendFeedbackToWeDeploy(liked) {
			return WeDeploy.data('db.wedeploy.com').create('feedback', {
				liked: liked,
...
_metalSoy2.default.register(Feedback, _Feedback2.default);
...
class Feedback extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(Feedback, templates);
